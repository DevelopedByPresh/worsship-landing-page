      ...
      >
        <nav className="max-w-7xl mx-auto px-6 md:px-10 py-4 flex items-center justify-between">
          ...
          <div className="hidden md:flex items-center gap-4 flex-shrink-0">
            ...
            <a
              href="#"
              className={`px-5 py-2 rounded-full text-sm shadow-md ${
                ...
                <button
                  ...
                  className={`px-3 py-1.5 text-sm cursor-pointer rounded-full transition ${
                    mode === "church"
                      ...
                      : "text-[#2B04DB] font-semibold bg-white"
                  }`}
                >
                  As a Church
                </button>
          ...
          >
            ...
            <div className="flex flex-col sm:flex-row items-center gap-5 mt-10">
              <motion.a
                ...
                whileTap={{ scale: 0.98 }}
                href="#"
                className="bg-[#2B04DB] text-white px-10 py-2.5 rounded-full text-base text-sm font-semibold shadow-lg shadow-[#4C35F1]/30 hover:shadow-xl transition"
              >
                Join The WaitList
              </motion.a>
