  ...
  return (
    <section id="header" className="relative h-[100vh] w-full overflow-hidden flex flex-col">
      ...
      >
        ...
        <div className="flex items-center gap-2 mb-6 bg-white/70 backdrop-blur-md border border-white/30 rounded-full p-1">
          <button
            ...
            className={`px-4 py-1.5 text-sm  cursor-pointer rounded-full transition ${
              mode === "church" ? "bg-[#2B04DB]  text-white font-semibold" : "bg-white text-[#2B04DB]"
            }`}
          >
            As a Church
          </button>
          ...
          <button
            onClick={() => setMode("user")}
            className={`px-4 py-1.5 text-sm  cursor-pointer rounded-full transition ${
              mode === "user" ? "bg-[#2B04DB] text-white font-semibold" : "text-[#2B04DB] font-semibold"
            }`}
          >
            As a User
          </button>
        ...
        <p className="text-gray-900 text-[14px] font-small max-w-2xl mx-auto mb-8 leading-relaxed">
